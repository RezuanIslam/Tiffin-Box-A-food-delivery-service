...
<html>
  ...
  <form action="Rider_Login_Validation.php" method="post" style="display:inline-block; text-align: center; width: 50%; margin-left : 25% ;background-color: powderblue;">
        <fieldset>
            <legend >Login</legend>
            ...
            <a href="Rider_Registration.php">Create New Account</a>
